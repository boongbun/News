    ...
    public class TemplateData
    {
        public MenuModel ListMenu = new MenuModel()
        {
            ListMenu = new List<MENU_ENTITY>()
            {
                ...
                new MENU_ENTITY(){MENU_PARENT_ID = 0, MENU_ID = 2, MENU_NAME = "Giới thiệu", MENU_ICON_MATERIAL = "layers", MENU_PATH = "#", STT = 2},
                ...
                new MENU_ENTITY(){MENU_PARENT_ID = 0, MENU_ID = 3, MENU_NAME = "Dịch vụ", MENU_ICON_MATERIAL = "layers", MENU_PATH = "#", STT = 3},
